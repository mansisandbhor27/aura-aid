...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      createCampaign: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`createCampaign: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const goalAmount__0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(goalAmount__0),
      ...
      donate: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(campaignId__0).concat(_descriptor_0.toValue(amount__0)),
  ...
  _createCampaign_0(context, partialProofData, goalAmount__0) {
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(newId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(goalAmount_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    return [];
  }
  _donate_0(context, partialProofData, campaignId__0, amount__0) {
    const campaignId_0 = campaignId__0;
    const amount_0 = amount__0;
    const exists_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
                                                                               [
                                                                                { dup: { n: 0 } },
                                                                                { idx: { cached: false,
    ...
    if (exists_0) {
      this._receiveUnshielded_0(context,
                                ...
                                this._nativeToken_0(),
                                amount_0);
      const currentBalance_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                         partialProofData,
                                                                                         [
                                                                                          { dup: { n: 0 } },
                                                                                          { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'aura_aid.compact line 7 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    campaignBalances: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'aura_aid.compact line 10 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
